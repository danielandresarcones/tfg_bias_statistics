...
PATH = "code/input/data/cantilever_dataset.csv"
...
if __name__ == "__main__":
    ...
    plot_dataset(dataset, output_path="code/output/figures/cantilever_dataset.png")
    # plot_dataset(dataset, output_path="output/figures/cantilever_dataset.png")
    print(f"Dataset saved to {PATH}")
    print("Plot saved to output/figures/cantilever_dataset.png")